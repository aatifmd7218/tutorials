...
export async function getServerSideProps({ params }) {
  try {
    ...
    let { subTutorialsData, firstSubTutorialContent } =
      await fetchSubTutorialsData(topicslug);
    let tutorialStatus = await fetchTutorialStatus(topicslug);
    return {
      props: {
        subTutorialsData,
        firstSubTutorialContent,
        tutorialStatus,
        topicslug,
      },
    };
...
export default function SubTutorialPage({
  subTutorialsData,
  firstSubTutorialContent,
  tutorialStatus,
  topicslug,
                    ...
                    <>
                      ...
                      <h3
                        dangerouslySetInnerHTML={{
                          __html: firstSubTutorialContent,
                        }}
                      ></h3>
                    </>
                  )}
